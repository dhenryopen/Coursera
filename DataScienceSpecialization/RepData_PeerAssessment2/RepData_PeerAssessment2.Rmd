---
title: "Economic & Human Impact of Major Weather Events in the United States, 1950-2011"
output:
  pdf_document:
...
```{r chunk1, results=FALSE, message=FALSE, comment=NA}
...
```{r chunk2, cache=TRUE, results='hide', message=FALSE}
...
```{r chunk4, results=FALSE, message=FALSE, cache=TRUE, fig.align='center'}
